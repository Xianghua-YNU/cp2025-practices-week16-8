...
| 方法 | 计算时间 (秒) | 时间步数 | 效率评价 |
|------|---------------|----------|----------|
| 显式差分法 | [0.0329] | [填入] | [高效但受限于稳定性参数r，适用于小规模问题或对实时性要求高的场景] |
| 隐式差分法 | [0.0040] | [填入] | [低效但无条件稳定，适合于大规模问题和对精度要求高的场景] |
| Crank-Nicolson | [0.0010] | [填入] | [最高效且无条件稳定，是一种平衡效率和精度的较好选择] |
| solve_ivp | [0.0746] | [填入] | [参考解，精度高但计算时间长，适合用于验证其他方法的准确性] |
